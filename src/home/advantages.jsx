...
const Advantages = () => {
  return (
    <main className='lg:mt-48 mt-28'>
      ...
      {/* Advantages */}
      <section className='flex lg:flex-row flex-col mt-5'>
        <div className='lg:order-1 lg:mr-4 flex flex-col justify-around order-2 basis-3/5'>
          ...
          <section className='lg:flex justify-between mt-8'>
            ...
            <div className='basis-[47%] border-border border-[1px] lg:border-0 p-2 lg:p-0 rounded-xl'>
              <img src={video} className='h-12' alt='video' />
              <p className='font-semibold text-title text-lg mt-3'>
            ...
            <div className='basis-[47%] border-border border-[1px] lg:border-0 p-2 lg:p-0 rounded-xl lg:mt-0 mt-10'>
              <img src={sound} className='h-12' alt='video' />
              <p className='font-semibold text-title text-lg mt-3'>
          ...
          <section className='lg:flex justify-between mt-8'>
            {/* Item 3 */}
            <div className='basis-[47%] border-border border-[1px] lg:border-0 p-2 lg:p-0 rounded-xl'>
              <img src={calendar} className='h-12' alt='video' />
              <p className='font-semibold text-title text-lg mt-3'>
            ...
            {/* Item 4 */}
            <div className='basis-[47%] border-border border-[1px] lg:border-0 p-2 lg:p-0 rounded-xl lg:mt-0 mt-10'>
              <img src={lock} className='h-12' alt='video' />
              <p className='font-semibold text-title text-lg mt-3'>
                Bank-grade security
              </p>
              <p className='text-content mt-3'>
        ...
        <div className='lg:order-2 order-1 basis-2/5 flex justify-center'>
