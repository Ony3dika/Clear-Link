...
const Support = () => {
  return (
    <main className='lg:mt-48 lg:flex justify-between mt-16'>
      ...
      <section className='basis-[47%] lg:mt-0 mt-10'>
        <div className='bg-secondary border-[1.5px] border-border rounded-md p-6'>
          <div className='flex justify-between items-center'>
            <p className='text-title font-semibold text-sm lg:text-base'>
          ...
          <p className='mt-5 text-content text-sm lg:text-base'>
        ...
        <div className='flex justify-between mx-2 lg:mx-5 mt-5 py-3 lg:py-5 items-center'>
          <p className='font-semibold text-xs lg:text-base text-title'>
